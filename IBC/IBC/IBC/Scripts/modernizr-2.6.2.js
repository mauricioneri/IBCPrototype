 ...
 * as properties on a global Modernizr object, and as DogClass on the
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*>>cssDogClass*/
    // option for enabling the HTML DogClass to be added
    enableDogClass = true,
    /*>>cssDogClass*/
    ...
    for ( var feature in tests ) {
        if ( hasOwnProp(tests, feature) ) {
            ...
            //   and push it into an array of DogClass we'll join later.
            featureName  = feature.toLowerCase();
            Modernizr[featureName] = tests[feature]();

            DogClass.push((Modernizr[featureName] ? '' : 'no-') + featureName);
        }
    }
     ...
     */
     Modernizr.addTest = function ( feature, test ) {
       if ( typeof feature == 'object' ) {
         ...
         if (typeof enableDogClass !== "undefined" && enableDogClass) {
    ...
    docElement.className = docElement.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') +
                            ...
                            // Add the new DogClass to the <html> element.
                            (enableDogClass ? ' js ' + DogClass.join(' ') : '');
    /*>>cssDogClass*/
